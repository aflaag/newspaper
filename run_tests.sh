...
run_test sample_inputs/spacing_in.txt expected_outputs/spacing_out.txt 3 7 18 1 false
run_test sample_inputs/spacing2_in.txt expected_outputs/spacing2_out.txt 3 7 18 1 false
run_test sample_inputs/super_short_in.txt expected_outputs/super_short_out.txt 3 7 21 1 false
...
run_test sample_inputs/spacing_in.txt expected_outputs/spacing_out.txt 3 7 18 1 true
run_test sample_inputs/spacing2_in.txt expected_outputs/spacing2_out.txt 3 7 18 1 true
run_test sample_inputs/super_short_in.txt expected_outputs/super_short_out.txt 3 7 21 1 true
