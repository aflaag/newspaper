...
int main(int argc, char* argv[]) {
    ...
    char* input_content = "a x x b x x c c iaone come stae"; h_col = 7; w_col = 18; // TODO: mo questo s'è rotto, fixalo e prova anche con lunghezze diverse (magari che fanno si che sia proprio l'ultimo bucket preciso ad avere più spazi)
